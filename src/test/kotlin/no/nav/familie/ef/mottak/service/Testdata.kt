...
internal object Testdata {
    ...
    private fun lagPersonaliaForArbeidssøker(): PersonaliaArbeidssøker = PersonaliaArbeidssøker(
    ...
    val søknadOvergangsstønadNy = SøknadOvergangsstønad(
        Søknadsfelt(
            "detaljer",
            Innsendingsdetaljer(Søknadsfelt("mottat", mottat), mottat.minusDays(1).toLocalDate()),
        ),
    ...
    val søknadOvergangsstønadMedTommeFelter = SøknadOvergangsstønad(
        Søknadsfelt(
            "detaljer",
            Innsendingsdetaljer(Søknadsfelt("mottat", mottat), mottat.minusDays(1).toLocalDate()),
        ),
    ...
    val søknadBarnetilsynNy = SøknadBarnetilsyn(
        Søknadsfelt(
            "detaljer",
            Innsendingsdetaljer(Søknadsfelt("mottat", mottat), mottat.minusDays(1).toLocalDate()),
        ),
    ...
    fun utdanning(): UnderUtdanning = UnderUtdanning(
    ...
    private fun stønadsstart() = Stønadsstart(
    ...
    @Suppress("LongLine")
    private fun situasjon(): Situasjon = Situasjon(
        Søknadsfelt(
    ...
    @Suppress("LongLine")
    private fun situasjonNy(): Situasjon = Situasjon(
        Søknadsfelt(
            "Gjelder noe av dette deg?",
            listOf(
                "Barnet mitt er sykt",
    ...
    @Suppress("LongLine")
    private fun aktivitet(): Aktivitet = Aktivitet(
        ...
        arbeidssøker = Søknadsfelt(
            ...
            Arbeidssøker(
                ...
                kanDuSkaffeBarnepassInnenEnUke = Søknadsfelt(
    ...
    private fun ufødtBarn(): Barn = Barn(
    ...
    @Suppress("LongLine")
    private fun barn(barnetilsyn: Boolean = false): Barn = Barn(
        ...
        samvær = Søknadsfelt(
            ...
            Samvær(
                ...
                hvordanPraktiseresSamværet = Søknadsfelt(
    ...
    @Suppress("LongLine")
    private fun barn2(barnetilsyn: Boolean = false): Barn = Barn(
    ...
    private fun barnepass(): Søknadsfelt<Barnepass> = Søknadsfelt(
        "Barnepass",
        Barnepass(
    ...
    private fun sivilstandsplaner(): Sivilstandsplaner = Sivilstandsplaner(
    ...
    private fun bosituasjon(): Bosituasjon = Bosituasjon(
        Søknadsfelt(
    ...
    private fun medlemskapsdetaljer(): Medlemskapsdetaljer = Medlemskapsdetaljer(
    ...
    private fun medlemskapsdetaljerNy(): Medlemskapsdetaljer = Medlemskapsdetaljer(
        oppholderDuDegINorge = Søknadsfelt("Oppholder du deg i Norge?", true),
        bosattNorgeSisteÅrene = Søknadsfelt("Har du bodd i Norge de siste tre årene?", true),
        utenlandsopphold = Søknadsfelt(
            "Utenlandsopphold",
    ...
    @Suppress("LongLine")
    private fun sivilstandsdetaljer(): Sivilstandsdetaljer = Sivilstandsdetaljer(
        Søknadsfelt(
    ...
    private fun personalia(): Personalia = Personalia(
    ...
    private fun adresseSøknadsfelt(): Søknadsfelt<Adresse> = Søknadsfelt(
        "Adresse",
        Adresse(
            "Jerpefaret 5C",
            "1440",
    ...
    private fun personMinimum(): PersonMinimum = PersonMinimum(
